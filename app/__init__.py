...
def _migrate_database():
    column_defs = {
        ...
        'support_attachment': {'case_type': 'VARCHAR(30)', 'source_id': 'INTEGER', 'message_id': 'INTEGER', 'uploaded_by_user_id': 'INTEGER', 'filename': 'VARCHAR(255)', 'original_filename': 'VARCHAR(255)', 'content_type': 'VARCHAR(120)', 'file_size': 'INTEGER DEFAULT 0', 'storage_path': 'VARCHAR(500)', 'created_at': 'TIMESTAMP'},
    ...
    ddl_statements = [
        ...
        """CREATE TABLE IF NOT EXISTS support_attachment (id INTEGER PRIMARY KEY, case_type VARCHAR(30) NOT NULL, source_id INTEGER NOT NULL, message_id INTEGER, uploaded_by_user_id INTEGER, filename VARCHAR(255) NOT NULL, original_filename VARCHAR(255), content_type VARCHAR(120), file_size INTEGER DEFAULT 0, storage_path VARCHAR(500) NOT NULL, created_at TIMESTAMP)""",
...
def _ensure_database_indexes():
    ...
    try:
        ...
        index_statements = [
            ...
            "CREATE INDEX IF NOT EXISTS ix_support_attachment_case_source_created ON support_attachment (case_type, source_id, created_at)",
            "CREATE INDEX IF NOT EXISTS ix_support_attachment_message_id ON support_attachment (message_id)",
