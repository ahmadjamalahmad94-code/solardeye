...
class User(db.Model):
    ...
    default_device_type = db.Column(db.String(50), nullable=True, default='deye')
...
class Device(db.Model):
    ...
    api_provider = db.Column(db.String(50), nullable=False, default='deye', index=True)
    api_base_url = db.Column(db.String(255), nullable=True)
    external_device_id = db.Column(db.String(120), nullable=True, index=True)
    device_uid = db.Column(db.String(120), nullable=True, index=True)
    ...
    auth_mode = db.Column(db.String(30), default='credentials')
